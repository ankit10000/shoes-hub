...
export default function Example() {
  ...
  const generateWhatsAppLink = (productimageSrc, productName, productPrice) => {
    const message = `Check out this product: \nImage-Url: http://localhost:3000${productimageSrc} \nProduct Name = ${productName} \nPrice = ${productPrice}
                      \nCustomer Detail: \nCustomer Name:  \nCustomer Contact Number:  \nCustomer Address: \nPINCODE: `;
    const encodedMessage = encodeURIComponent(message);
    return `https://wa.me/?phone=9636819197&text=${encodedMessage}`;
  };



  return (
    <div className="custom-css-productdetail">
      <div className="pt-6 bg-white custom-css-productdetails">
        <nav aria-label="Breadcrumb">
          <ol role="list" className="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <li className="text-sm">
              <Link to={"/"} aria-current="page" className="text-2xl text-gray-500 hover:text-gray-600 border-3 px-2 py-1 rounded-5 ">
                {"<Back"}
              </Link>
            </li>
          </ol>
